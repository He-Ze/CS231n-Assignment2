    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers):
            ...
            if i < self.num_layers - 1:
                if self.normalization == "batchnorm":
                    a, cache_bn[i] = batchnorm_forward(a, self.params["gamma" + str(i + 1)], self.params["beta" + str(i + 1)], self.bn_params[i],)
                elif self.normalization == "layernorm":
                    a, cache_bn[i] = layernorm_forward(a, self.params["gamma" + str(i + 1)], self.params["beta" + str(i + 1)], self.bn_params[i],)
